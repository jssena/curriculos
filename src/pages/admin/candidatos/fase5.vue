          ...
          <q-card class="full-width row">
            <q-select 
             ...
             <div class="col float-left q-pa-md q-gutter-sm">
                <q-radio keep-color v-model="filter.status" val="1" color="green" /> 
        ...
        >
          <q-card :class="props.selected ? 'bg-grey-2' : ''" class="text-weight-medium">
            ...
            <q-card-actions align="right">
                ...
                <q-radio keep-color v-model="props.row.fase5" :val="1"  @input="dialogItem(props.row)"  color="teal" />
                <q-radio keep-color v-model="props.row.fase5" :val="2"  @input="atualizaStatusStandBy(props.row)" color="orange" />
                <q-radio keep-color v-model="props.row.fase5" :val="3"  @input="dialogItem(props.row)" color="red" />
      ...
      <template v-slot:body="props"  v-if="!list">
        <q-tr :props="props">
            ...
            <q-td key="nome" :props="props" >
              <q-radio dense keep-color v-model="props.row.fase5" class="q-px-sm" :val="1"  @input="dialogItem(props.row)"  color="teal" />
              <q-radio  dense  keep-color v-model="props.row.fase5"   :val="2"  @input="atualizaStatusStandBy(props.row)" color="orange" />
              <q-radio  dense  keep-color v-model="props.row.fase5"  class="q-px-sm" :val="3"  @input="dialogItem(props.row)" color="red" />
    ...
    atualizaStatusStandBy (value){
     ...
     atualizaStatus (value){
      ...
      formStatus = {
        ...
        fase5: value.candidato.fase5,
        vaga_id: value.candidato.vaga_id,
        pagina:'candidatosStatus'
      }
     
      if(value.candidato.fase5 == 1){
        assunto = frases.fase5.assuntoPassou
        message =  frases.fase5.passou
        
      }else if(value.candidato.fase5 == 3){
        assunto = frases.fase5.assuntoNaoPassou
        message =  frases.fase5.naoPassou
      }
